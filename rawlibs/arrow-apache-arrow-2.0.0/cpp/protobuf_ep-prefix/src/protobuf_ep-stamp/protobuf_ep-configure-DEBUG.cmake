...
set(command "/snap/cmake/619/bin/cmake;-DCMAKE_C_COMPILER=/usr/bin/cc;-DCMAKE_CXX_COMPILER=/usr/bin/c++;-DCMAKE_AR=/usr/bin/ar;-DCMAKE_RANLIB=/usr/bin/ranlib;-DCMAKE_BUILD_TYPE=DEBUG;-DCMAKE_C_FLAGS= -ggdb -O0 -g -fPIC;-DCMAKE_C_FLAGS_DEBUG= -ggdb -O0 -g -fPIC;-DCMAKE_CXX_FLAGS= -fdiagnostics-color=always -ggdb -O0 -g -fPIC;-DCMAKE_CXX_FLAGS_DEBUG= -fdiagnostics-color=always -ggdb -O0 -g -fPIC;-DCMAKE_EXPORT_NO_PACKAGE_REGISTRY=;-DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY=;-DBUILD_SHARED_LIBS=OFF;-DCMAKE_INSTALL_LIBDIR=lib;-DCMAKE_INSTALL_PREFIX=/home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-install;-Dprotobuf_BUILD_TESTS=OFF;-Dprotobuf_DEBUG_POSTFIX=;-GUnix Makefiles;/home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-prefix/src/protobuf_ep/cmake")
set(log_merged "")
set(log_output_on_failure "1")
set(stdout_log "/home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-prefix/src/protobuf_ep-stamp/protobuf_ep-configure-out.log")
set(stderr_log "/home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-prefix/src/protobuf_ep-stamp/protobuf_ep-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-prefix/src/protobuf_ep-stamp/protobuf_ep-configure-*.log")
  endif()
  ...
  set(msg "protobuf_ep configure command succeeded.  See also /home/james/CLionProjects/PQ/rawlibs/arrow-apache-arrow-2.0.0/cpp/protobuf_ep-prefix/src/protobuf_ep-stamp/protobuf_ep-configure-*.log")
  message(STATUS "${msg}")
endif()
